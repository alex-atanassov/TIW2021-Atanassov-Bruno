...
--
-- Host: 127.0.0.1    Database: project_db_cs
-- ------------------------------------------------------
...
CREATE TABLE `album` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `name_2` (`name`,`artist`,`userid`),
  KEY `userid` (`userid`),
...
CREATE TABLE `track` (
  ...
  CONSTRAINT `track_ibfk_2` FOREIGN KEY (`albumid`) REFERENCES `album` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `track_ibfk_3` FOREIGN KEY (`genre`) REFERENCES `genre` (`name`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2021-06-22 19:25:49
